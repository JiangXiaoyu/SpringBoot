...
import com.bbbbb.pay.dao.UploadIdCardDao;
import com.bbbbb.pay.dao.UploadIdCardLogDao;
import com.bbbbb.pay.entity.UploadIdCard;
import com.bbbbb.pay.entity.UploadIdCardLog;
...
public class UploadServiceImpl implements IUploadService {
	...
	public Map<String, Object> idCardImage(PhotoInfo photoInfo) {
		...
		// 再写入t_bbbbb_upload_idcard_log 上传日志表
	...
	public Map<String, String> bankCardImage(String cardNo, String cardImgData, String eProtocolAcNo) {
		...
		//写日志表 t_bbbbb_upload_bankcard_log  
